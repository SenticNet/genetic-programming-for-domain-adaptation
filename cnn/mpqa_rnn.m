...
if loopk==loopmax
   ...
   filename = sprintf('../gp/neu_gp0/nlp_neu1.txt');
   dlmwrite(filename,newdata);
   filename = sprintf('../gp/neu_gp0/test_ind0');
   dlmwrite(filename,2*size(test,2));
